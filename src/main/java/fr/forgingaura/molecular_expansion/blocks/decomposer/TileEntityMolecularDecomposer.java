...
public class TileEntityMolecularDecomposer extends TileEntity implements IInventory, ITickable {
    ...
    {
        return this.hasCustomName() ? this.customName : "container.molecular_decomposer";
    }
    ...
    public void update()
    {
        ...
        if(!this.world.isRemote)
        {
            ...
            {
                flag1 = true;
                MolecularDecomposer.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack result = MolecularDecomposerRecipes.getInstance().getDecomposerResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));
    ...
    public void smeltItem()
    {
        if(this.canSmelt())
        {
            ...
            ItemStack result = MolecularDecomposerRecipes.getInstance().getDecomposerResult(input1, input2);
            ItemStack output = (ItemStack)this.inventory.get(3);
    ...
    {
        return "molecular_expansion:molecular_decomposer";
    }
