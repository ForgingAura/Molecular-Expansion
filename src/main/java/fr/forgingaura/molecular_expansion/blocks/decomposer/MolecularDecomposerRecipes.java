...
public class MolecularDecomposerRecipes {

    private static final MolecularDecomposerRecipes INSTANCE = new MolecularDecomposerRecipes();
    private final Table<ItemStack, ItemStack, ItemStack> smeltingList = HashBasedTable.<ItemStack, ItemStack, ItemStack>create();
    private final Map<ItemStack, Float> experienceList = Maps.<ItemStack, Float>newHashMap();

    public static MolecularDecomposerRecipes getInstance()
    {
        return INSTANCE;
    }

    private MolecularDecomposerRecipes()
    {
        addDecomposerRecipe(new ItemStack(MainsItems.testtube), new ItemStack(Items.COAL), new ItemStack(AtomsItems.carbone), 5.0F);
        addDecomposerRecipe(new ItemStack(MainsItems.testtube), new ItemStack(Items.GUNPOWDER), new ItemStack(AtomsItems.soufre), 5.0F);
    }
